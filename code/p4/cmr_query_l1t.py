"""
Adım 1 — CMR'da AST_L1T granül sorgula (Avanos AOI, 2020-2024, en az bulutlu).
Girdi  : sabit parametreler (bbox, tarih, bulut eşiği)
Çıktı  : terminale granül listesi + data/aster/_cmr_l1t.json manifest
"""
...
# ── Girdi parametreleri ──────────────────────────────────────────────────────
BBOX        = "34.6,38.5,35.1,39.0"   # west,south,east,north
START       = "2020-01-01T00:00:00Z"
END         = "2024-12-31T23:59:59Z"
MAX_CLOUD   = 20.0                     # % — bu değeri aşan sahneler atlanır
PAGE_SIZE   = 20
SHORT_NAME  = "AST_L1T"
OUT_JSON    = Path("data/aster/_cmr_l1t.json")
# ────────────────────────────────────────────────────────────────────────────
...
params = {
    ...
    "day_night_flag": "DAY",
    "sort_key":     "+cloud_cover",   # en az bulutlu önce
    "page_size":    str(PAGE_SIZE),
}

print("=" * 60)
print(f"Sorgu  : {SHORT_NAME}")
print(f"BBox   : {BBOX}")
...
if eligible:
    ...
    print("[UYARI] Uygun granül bulunamadı. AST_L1B sorgusu için cmr_query_l1b.py çalıştırın.")
