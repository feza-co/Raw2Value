  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-8 pt-16">
      <div className="w-full max-w-sm">
        <p className="font-body text-xs text-stone-300 uppercase tracking-widest mb-8">Kayıt</p>
        <h1 className="font-display font-light text-ink text-4xl mb-12">Hesap oluşturun</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
          <div>
            <label className="font-body text-xs text-stone-300 uppercase tracking-widest block mb-2">Ad Soyad</label>
            <input
              {...register('full_name')}
              type="text"
          ...
          <div>
            <label className="font-body text-xs text-stone-300 uppercase tracking-widest block mb-2">E-posta</label>
            <input
              {...register('email')}
              type="email"
              className="w-full border border-stone-100 bg-white px-4 py-3 font-body text-sm text-charcoal focus:outline-none focus:border-amber transition-colors duration-150"
          ...
          <div>
            <label className="font-body text-xs text-stone-300 uppercase tracking-widest block mb-2">Şifre</label>
            <input
              {...register('password')}
              type="password"
              className="w-full border border-stone-100 bg-white px-4 py-3 font-body text-sm text-charcoal focus:outline-none focus:border-amber transition-colors duration-150"
        ...
        <p className="font-body text-sm text-stone-300 mt-8">
          ...
          <a href="/login" className="text-amber hover:text-amber-dark transition-colors duration-150">
            Giriş yapın
          </a>
        </p>
      </div>
